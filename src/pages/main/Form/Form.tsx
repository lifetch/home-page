...
export default function Form({
  ...
  const submitHandler: SubmitHandler<FormValues> = (data) => {
    ...
    const msg = `Имя: ${data.name},%0AКомпания: ${data.company},%0AТелефон: ${
      data.phoneNumber
    },%0AПочта: ${data.email},%0A${
      data.telegram && `Телеграмм: ${data.telegram},%0A`
    }Описание проекта: ${data.description},%0A`;
    fetch(
  ...
  const isEmail = (email: string) => {
    return email.match(/^[-\w.]+@([A-z0-9][-A-z0-9]+\.)+[A-z]{2,4}$/)
      ? true
      : false;
  };

  return (
    <div className={style.wrapper} id="contact-form">
      <LazyImage
        src={figure}
        width={"auto"}
        height={1461}
      ...
      <div className={style["form-padding"]}>
        <div className={style["form-block"]}>
          <div className={style["form-titles"]}>
            <h1 className={style.title}>Форма заявки</h1>
          ...
          <div className={style["form-container"]}>
            ...
            >
              <div className={style["form-input"]}>
                <p className={style["input-title"]}>
                  Имя <span>*</span>
                </p>
                <input
                  type="text"
                  className={errors.name && style.alert}
              ...
              <div className={style["form-input"]}>
                ...
                <input
                  type="text"
                  className={errors.company && style.alert}
                  placeholder={"LifeTech"}
              ...
              <div className={style["form-input"]}>
                ...
                <input
                  type="text"
                  className={errors.phoneNumber && style.alert}
              ...
              <div className={style["form-input"]}>
                ...
                <input
                  type="text"
                  className={errors.email && style.alert}
                  placeholder={"lifetech@gmail.com"}
                  {...register("email", {
                    required: true,
                    validate: isEmail,
                  })}
              ...
              <div className={style["form-input"]}>
                <p className={style["input-title"]}>
                  Описание проекта <span>*</span>
                </p>
                <textarea
                  rows={5}
                  className={errors.description && style.alert}
              ...
              <div className={style["checkbox-input"]}>
                ...
                />
                <p id={errors.approval && style.alert_checkbox}>
                  Согласен с{" "}
