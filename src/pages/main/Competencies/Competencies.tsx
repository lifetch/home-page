    ...
    <div className={style.wrapper}>
      ...
      <div className={style.information}>
        <p className={style.description}>
          Мы разрабатываем веб-сервисы и все, что с ними связано: сайты,
          приложения, внутренние системы, чат-боты и mini-apps
        </p>
        <p className={style.description}>
          Готовы реализовать проекты любой сложности с помощью следующего
      ...
      <div className={style.content}>
        <div className={style.row_1}>
          <div className={style.blocks}>
            <a href="/competence/frontend" className={style.block}>
              <div>
                <LazyImage
                  src={figure_1}
                  width={567}
            ...
            <a href="/competence/uiux" className={style.block}>
              <LazyImage
                src={uiuxfig}
                width={375}
                height={417}
            ...
            <a href="/competence/ai" className={style.block}>
              <LazyImage
                src={aifig}
                width={375}
                height={417}
            ...
            <a href="/competence/iot" className={style.block}>
              <LazyImage
                src={iotfig}
                width={375}
                height={417}
        ...
        <div className={style.row_2}>
          <div className={style.blocks}>
            <a href="/competence/mobile" className={style.block}>
              <div>
                <LazyImage
                  src={figure_2}
                  width={319}
            ...
            <a href="/competence/bots" className={style.block}>
              <div>
                <LazyImage
                  src={figure_4}
                  width={586}
            ...
            <a href="/competence/qa" className={style.block}>
              <LazyImage
                src={qafig}
                width={375}
                height={417}
            ...
            <a href="/competence/consulting" className={style.block}>
              <LazyImage
                src={cons}
                width={375}
                height={417}
        ...
        <a href={"/competence/miniapps"} className={style.end_block}>
          <div className={style.end_block_center}>
            ...
            {width > 767 && (
              <p className={style.subtitle}>
                Lorem ipsum dolor sit amet consectetur. In vestibulum egestas
                proin a nibh adipiscing pulvinar adipiscing dolor. Arcu in
                mauris eu nunc.
              </p>
            )}
          </div>
